  ...
  return (
    <>
      <div className="flex justify-center">
        <h4 className="text-center font-bold text-3xl pt-4 pb-1 border-b-2 border-blue-400 inline-block">
          Shop The best
        </h4>
      </div>
      ...
      <div className="container mx-auto flex flex-col gap-4">
        ...
        <div className="flex justify-start gap-3">
          <button
            className="border-2 border-blue-400 md:text-[1.2rem] font-bold p-1 md:p-2 rounded-full"
            type="button"
        ...
        <div className="flex justify-start gap-3 ">
          <button
            className="border-2 border-blue-400 md:text-[1.2rem] font-bold py-1 md:py-2 px-8 rounded-full"
            type="button"
      ...
      <div className="mt-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 justify-items-center align-items-center gap-4  p-4 ">
        {filteredProducts.length > 0
          ? filteredProducts.map((ele) => (
              <>
                <div className="border-2 border-blue-400 rounded-md w-[300px] p-3 flex flex-col justify-center items-center gap-3">
